...
You're very interested in findout the rate of cases per 100,000 population. Create a new column called "rate" with the calculated values.

Hint: R allows you to use manipulate variables within a data frame to calculate new values so long as the rows and data types match up. For example: df$var1 + df$var2 = df$var3
