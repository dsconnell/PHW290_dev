...
# calcualte bmi for the first observation
...
It's possible to nest functions within another function. Let's try this idea by first writing a function called feet_to_centimeter() that converts height from feet to centimeters. We created another function for you called lbs_to_kg() that converts weight from pounds to kg. 
